...
import Foto1 from "@/assets/prototipo1.jpg";
import Foto2 from "@/assets/prototipo1.jpg";
import Foto3 from "@/assets/prototipo1.jpg";
...
export default function Vehicle1() {
  ...
  const sections = [
    { title: t('vehicles1.prototype1.design.title'),       description: t('vehicles1.prototype1.design.description'),       image: Foto1, imageRight: true  },
    { title: t('vehicles1.prototype1.components.title'),   description: t('vehicles1.prototype1.components.description'),   image: Foto2, imageRight: false },
    { title: t('vehicles1.prototype1.achievements.title'), description: t('vehicles1.prototype1.achievements.description'), image: Foto3, imageRight: true  },
  ];
      ...
      <div className="relative overflow-hidden py-20">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-white/50 text-lg">{t('vehicles1.prototype1.subtitle')}</p>
          </motion.div>
        </div>
      </div>
